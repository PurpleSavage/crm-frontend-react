...
export async function obtenerCLientes():Promise<objClientes[]>{
    const url = `${import.meta.env.VITE_FRONTEND_URL}/all-clients`
    const respuesta = await fetch(url)
    const resultado =await respuesta.json()
    return resultado
}
export async function obtenerCLiente(id:number):Promise<objClientes[]>{
    const url = `${import.meta.env.VITE_FRONTEND_URL}/client/${id}`
    const respuesta = await fetch(url)
    const resultado =await respuesta.json()
    return resultado
}
...
export async function agregarCliente(datos:ClienteDataInterface) {
    const url = `${import.meta.env.VITE_FRONTEND_URL}/add-client`
    try {
        const respuesta =await fetch(url,{
            method:'POST',
...
export async function actualizarCliente(id:number,datos:ClienteDataInterface){
    const url = `${import.meta.env.VITE_FRONTEND_URL}/update-client/${id}`
    try {
        const respuesta =await fetch(url,{
            method:'PUT',
            body:JSON.stringify(datos),
...
export async function eliminarCliente(id:number){
 ...
 const url = `${import.meta.env.VITE_FRONTEND_URL}/delete-client/${id}`
    try {
        const respuesta =await fetch(url,{
            method:'DELETE',
